...
import { registerGamepadEvents, registerKeyboardEvents, registerMouseEvents, sendClickEvent, sendMouseImage } from "../../js/register-events.js";
  ...
  async setupConnection(useWebSocket) {
    ...
    this.channel.onmessage = async (msg) => {
      ...
      if (data == "DeleteButtons"){
        ...
        else if (data_json['task_name'] == "Image"){
          var image = data_json["task_content"];
